...
public class loginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// sql = "select p.firstName, p.lastname, p.id, p.Address, p.City,
			// p.State, p.ZipCode, e.StartDate, e.HourlyRate, e.IsManager "+
			// "from person p, employee e "+
			// "where p.id=e.id and
			// concat(p.FirstName,p.lastname)='"+login+"'"+";";
			// ResultSet rs = statement.executeQuery(sql);
			// Statement statement2 =
			// connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
			// ResultSet.CONCUR_READ_ONLY);
			// sql = "select p.firstName, p.lastname, p.id, p.Address, p.City,
			// p.State, p.ZipCode, c.AccountNo, c.CreditCardNo, c.Phone,
			// c.Email, c.CreationDate, c.Rating "+
			...
			// ResultSet.CONCUR_READ_ONLY);
			// sql = "select p.firstName, p.lastname, p.id, p.Address, p.City,
			// p.State, p.ZipCode, e.ssn, e.StartDate, e.HourlyRate "+
			// "from person p, employee e "+
			...
			//
			// int i=0;
			// String cFirstName="";String cLastName="";String cID="";String
			// cAddress="";
			// String cCity="";String cState="";String cZipCode="";String
			// cStartDate="";
			// String cHourlyRate="";
			// while(rs2.next()){
			...
			// String cCity="";String cState="";String cZipCode="";String
			// cCreditCardNo="";
			// String cPhone="";String cEmail="";String cCreationDate="";String
			// cRating="";
			// while(rs1.next()){

...
<body style="font-size: 12pt; text-align: center" bgcolor="LightYellow">
    <br />
    <img src="dog.jpg" width="1200" height="600" />
    <br />
    <br />
    <form id="loginForm" action="login" method="post">
        ...
        <br />
        <input id="Button1" style="width: 70px; margin-top: 15px; margin-right: 10px;" type="submit" value="User" />
        <input id="Button2" style="width: 70px; margin-right: 10px;" type="button" value="Admin" onclick="return Button2_onclick()" />
        <input id="Button3" style="width: 76px" type="button" value="Register" onclick="return Button3_onclick()" />
        <br />
        <br />
    </form>
